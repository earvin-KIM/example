...
<body>
    <div class=top>
        <h1><a href="admin_main.php">홈화면</a></h1>
    </div>
    <?php
    ...
    <form method="post" action="imgsdel.php">
        ...
        <input type="checkbox" value="selectall" name="every" class='check-all'><b>Select All</b>
        <?php while ($board = $sql2->fetch_array()) {
          ...
          if ($board['img_path'] == null) {
            ...
            echo "<td><input type='checkbox' name='dels[]' class='ab' value=\"$src\"><a href='../home/board_page.php?_id=$src2';><img src=../home/upload/$src></a></td>";
          }
          if ($i % 3 == 0) {
            echo '</tr>';
          }
    ...
    if ($block_num >= $total_block) {
      ...
      $next = $page + 1;
      //next변수에 page + 1을 해준다.
      echo "<li><a href='?page=$next'>다음</a></li>"; //다음글자에 next변수를 링크한다. 현재 4페이지에 있다면 +1하여 5페이지로 이동하게 된다. // echo "<li><a href='?page=$next'></a></li>";
    }
    if ($page >= $total_page) {
