    ...
    return (
      <div>
        <div>
          ...
          <Button className="primary jumbotron-button" onClick={this.openNewPage.bind(this, 'github')}>
            GitHub
          </Button>{' '}
          <Button className="primary jumbotron-button" onClick={this.openNewPage.bind(this, 'medium')}>
            Medium
          </Button>
          <hr className="my-2" />
          <p>
            Developed with <span className="fa fa-heart"></span> by Ashish Deshpande
          </p>
        </div>
        <Container>
          <form>
