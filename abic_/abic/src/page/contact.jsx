...
import group32 from '../map.png';
import oval2 from '../map.png';
      ...
      <div className="contactcontactus contactscreen">
        ...
        <div className="contactflex-row">
          <div className="contactflex-col-1">
            ...
            <div className="contactflex-row-1">
              <div className="contactrectangle contactborder-1px-mountain-mist"></div>
              <div className="contactrectangle-1 contactborder-1px-mountain-mist"></div>
            </div>
            <div className="contacttext_label contactapplesdgothicneo-normal-chicago-30px">{text_Label5}</div>
            <div className="contactrectangle-2 contactborder-1px-mountain-mist"></div>
            ...
            <div className="contactflex-col-2">
              <div className="contactrectangle-3 contactborder-1px-mountain-mist"></div>
              <div className="contactgroup-1 contactborder-1px-mountain-mist">
        ...
        <div className="contactflex-col-3">
          ...
          <div className="contactoverlap-group" style={{ backgroundImage: `url(${overlapGroup})` }}>
            <img className="contactoval" src="oval.png" />
            <img className="contactoval-1" src={oval2} />
