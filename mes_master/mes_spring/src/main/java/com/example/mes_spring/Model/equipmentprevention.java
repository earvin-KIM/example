...
@Setter
@Entity
@Table(name = "equipmentprevention")
@DynamicInsert  // insert ㅅㅣ null 인 필드 제외하기위해 사용
@DynamicUpdate // update ㅅㅣ null 인 필드 제외하기위해 사용
public class equipmentprevention {
    ...
    public equipmentprevention(Integer ID, String Cleanness, String ControlPart, String Damage, String EquipmentCode, String Power,
