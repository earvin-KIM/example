...
--
-- Table structure for table `lavorer`
--

DROP TABLE IF EXISTS `lavorer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lavorer` (
  `id` int NOT NULL AUTO_INCREMENT,
  `country` varchar(255) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `hiredate` varchar(255) DEFAULT NULL,
  `lavorer_code` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `lavorer`
--

LOCK TABLES `lavorer` WRITE;
/*!40000 ALTER TABLE `lavorer` DISABLE KEYS */;
/*!40000 ALTER TABLE `lavorer` ENABLE KEYS */;
UNLOCK TABLES;
