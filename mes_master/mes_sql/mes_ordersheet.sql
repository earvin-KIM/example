...
CREATE TABLE `ordersheet` (
  ...
  `ahp` varchar(255) DEFAULT NULL,
  `atell` varchar(255) DEFAULT NULL,
  `applicant` varchar(255) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `oder_sheet_code` varchar(255) DEFAULT NULL,
  `payer` varchar(255) DEFAULT NULL,
  `price` varchar(255) DEFAULT NULL,
  `product_code` varchar(255) DEFAULT NULL,
  `quantity` int DEFAULT NULL,
  `radress` varchar(255) DEFAULT NULL,
  `rhp` varchar(255) DEFAULT NULL,
  `rtell` varchar(255) DEFAULT NULL,
